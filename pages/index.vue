<template>
  ...
  ">
  <div class="flex flex-wrap mt-[1%] mb-[10%] sm:mb-[40%]
  ...
  2xl:grid 2xl:grid-cols-2 2xl:gap-0  2xl:mt-[15%] 2xl:mx-[22%]
    ...
    <div>
          ...
          md:w-[55%] md:mx- md:justify-center md:mt-4 md:bg-white
          lg:w-[90%] lg:mx- lg:justify-center lg:mt-4 lg:bg-white
          xl:w-[95%] xl:mx- xl:justify-center xl:mt-4 xl:bg-white
          2xl:w-[90%] 2xl:mx- 2xl:justify-center 2xl:mt-4 2xl:bg-white
          ">
